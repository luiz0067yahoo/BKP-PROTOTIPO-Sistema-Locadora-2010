	...
	<table border="1">
        ...
        <tr>
		    <td>categoria:<select name="id_categoria" style="width:200px;">
				...
				?>
					<option value="<?php if ($result_categoria!=null)  echo $row["id_categoria"]?>"><?php if ($result_categoria!=null)  echo $row_categoria["nome"]?></option>
				<?php
					}
		...
		<?php
			...
			if( $_POST['acao']=='excluir'){				
				...
				$sql    = "update produtos set nome='".$_POST["nome"]."',id_categoria='".$_POST["id_categoria"]."',valor='".$_POST["valor"]."',descricao='".$_POST["descricao"]."',nome_cliente='".$_POST["nome_cliente"]."',telefone='".$_POST["telefone"]."',email='".$_POST["email"]."' where (id=".$_POST["id_produto"].");";
				//echo $sql;
				mysql_query($sql, $link);							
			}
		...
		?> 
				<tr>
					<td><a href="?id=<?php echo $row['id_produto'];?>"><?php echo $row['id_produto'];?></a></td>
